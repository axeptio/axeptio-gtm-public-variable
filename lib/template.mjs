...
//     ' = & < > as \uXXXX. template.tpl is kept in that form, but nothing in this
//     repo enforces it — the sibling has scripts/validate-template.mjs for that and
//     this one does not — so relying on it leaves the comparison one hand-edit away
//     from republishing on every run, forever.
//

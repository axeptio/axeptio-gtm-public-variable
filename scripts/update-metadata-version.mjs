...
//
// Invoked by .github/workflows/release.yml against the open release-please PR,
// so the entry merges together with VERSION and CHANGELOG.md (master is
// protected and cannot take a direct push).
// Inputs (environment):
//   RELEASE_TAG  e.g. "v1.2.0"  (the version the release PR is proposing)
//   RELEASE_SHA  the commit the gallery should publish — the last commit that
//                changed template.tpl, which is already on master (the release
